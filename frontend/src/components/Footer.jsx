...
const Footer = () => {
  ...
  return (
    <section>
        {/* SVG WAVE UP */}
        <div>
            <img src={svgTop} alt="svg background up" className="up-effect" />
        </div>
        ...
        <footer className="bg-primary text-white" id="footer">
            <div className="max-w-screen-xl mx-auto px-4 flex flex-col">
                <div className="py-4">
                    <h1 className="h1 font-Shrikhand text-center">MINTY</h1>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-start space-y-4 md:space-x-8 md:space-y-0 mb-10 md:mb-2">
                ...
                <div className="flex items-center justify-between py-4">
                    <div className="">
                        <p className="text-xs font-semibold md:text-sm py-2">LOCAL TIME</p>
                        <div id="localTime" className="text-white text-sm md:text-md flex flex-col">
                            <p>{currentTime.toLocaleTimeString()} EAT</p> {/* Display dynamic time */}
                            <p>{currentTime.toDateString()}</p> {/* Display dynamic date */}
                        </div>
                    </div>
                    <div className="">
                        <p className="te text-xs font-semibold md:text-sm py-2">SOCIALS</p>
