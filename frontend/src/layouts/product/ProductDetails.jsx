...
const ProductDetails = () => {
  ...
  const handleWhatsAppShare = () => {
    ...
    // Customize the font
    const assistHeader = 'Welcome to MINTY STORE';
    ...
    <section className="max-w-screen-xl mx-auto">
      <div className="mx-4">
        ...
        <div className="container py-4 flex items-center gap-3">
          <Link to="/">
            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" fill="#234645" viewBox="0 0 576 512">
              <path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" />
            </svg>
          </Link>
          <span className="text-sm text-gray-400">
            <svg xmlns="http://www.w3.org/2000/svg" width="0.6rem" fill="#234645" viewBox="0 0 320 512">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          {/* Left */}
          <div className="bg-contain bg-no-repeat bg-center py-44" style={{ backgroundImage: `url(${bag9})` }}></div>

          {/* Right */}
          <div className="text-primary">
            <h2 id="productName" className="text-2xl font-medium font-Shrikhand uppercase mb-2">Bag 1</h2>
            <div className="space-y-2">
              ...
              <p className="space-x-2">
                ...
                <span id="productSKU">MINTY001</span>
              </p>
            </div>
            <div className="flex items-baseline mb-1 space-x-2 font-Shrikhand mt-4">
              <p id="productPrice" className="text-xl text-primary font-semibold">Ksh 500</p>
            </div>

            <p id="productDescription" className="mt-4 text-gray-600">
            ...
            <div className="mt-6 flex border-b border-primary/50 pb-5 pt-5">
              <Link to="/order" className="bg-primary border border-primary text-white hover:text-secondary px-8 py-2 font-medium rounded-3xl flex items-center gap-2 transition duration-200 transform hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" width="1rem" fill="#FFFAFA" viewBox="0 0 576 512">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <button onClick={handleWhatsAppShare} aria-label="WhatsApp share" className="h-8 w-8 rounded-full border border-primary/50 flex items-center justify-center transition duration-200 transform hover:scale-125">
                <svg xmlns="http://www.w3.org/2000/svg" width="1rem" fill="#128C7E" viewBox="0 0 448 512">
