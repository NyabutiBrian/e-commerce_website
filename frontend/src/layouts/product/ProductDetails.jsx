    ...
    const updateOpenGraphMetaTags = () => {
      ...
      for (let i = 0; i < metaTags.length; i++) {
        if (metaTags[i].getAttribute('property') === 'og:image') {
          metaTags[i].setAttribute('content', bag9);
        } else if (metaTags[i].getAttribute('property') === 'og:title') {
          metaTags[i].setAttribute('content', 'APEX Bag');
        } else if (metaTags[i].getAttribute('property') === 'og:description') {
          metaTags[i].setAttribute(
            'content',
            'Explore our fashionable bags and meet your aspirations with Us! MINTY, Connecting new looks and design with enthusiastic lovers.'
          );
        }
      }
    };

    // Call the function to update Open Graph meta tags
