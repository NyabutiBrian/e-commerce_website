    ...
    <section className="max-w-screen-xl mx-auto scroll-m-28" id="about">
        <div className="py-8 mx-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 mx-auto justify-center">
                <div className="col-span-1 bg-white rounded-t-3xl lg:rounded-e-none lg:rounded-s-3xl border-primary border-t-2 lg:border-t-0 lg:border-l-2 px-3 py-6 flex justify-center items-center gap-5 shadow-lg">
