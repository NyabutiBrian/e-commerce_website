...
import bag5 from '../../assets/images/products/bag5.webp'
import bag6 from '../../assets/images/products/bag6.webp'
import bag7 from '../../assets/images/products/bag7.webp'
import bag8 from '../../assets/images/products/bag8.webp'
        ...
        <div className="py-8 mx-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4">
                ...
                <div className="bg-white shadow-2xl rounded-3xl overflow-hidden group transition duration-200 transform hover:scale-105">
                    <div className="relative bg-cover bg-no-repeat bg-center py-44" style={{ backgroundImage: `url(${bag5})` }}>
                    </div>
               ...
               {/* Product 2 */}
                <div className="bg-white shadow-2xl rounded-3xl overflow-hidden group transition duration-200 transform hover:scale-105">
                    <div className="relative bg-cover bg-no-repeat bg-center py-44" style={{ backgroundImage: `url(${bag6})` }}>
                    </div>
                ...
                {/* Product 3 */}
                <div className="bg-white shadow-2xl rounded-3xl overflow-hidden group transition duration-200 transform hover:scale-105">
                    <div className="relative bg-cover bg-no-repeat bg-center py-44" style={{ backgroundImage: `url(${bag7})` }}>
                    </div>
                ...
                {/* Product 4 */}
                <div className="bg-white shadow-2xl rounded-3xl overflow-hidden group transition duration-200 transform hover:scale-105">
                    <div className="relative bg-cover bg-no-repeat bg-center py-44" style={{ backgroundImage: `url(${bag8})` }}>
                    </div>
